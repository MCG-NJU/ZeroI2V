...
model = dict(
    ...
    backbone=dict(
        ...
        adapter_scale=0.5,
        num_tadapter=2,
        stdha_cfg=dict(shift_div=8, divide_head=False)),
    cls_head=dict(
        type='I3DHead',
        in_channels=1024,
        num_classes=400,
...
launcher = 'slurm'
work_dir = '.work_dirs/recognition/vit_zero_clip/N006aad_vit_zero_large_clip_k400_8x16x1_div8_40e_noerase'
randomness = dict(seed=None, diff_rank_seed=False, deterministic=False)
dist_params = dict(port=14592)
